-- ============================================================
-- Migration: Add variant_name to stage_movements and dispatches
-- Enables end-to-end variant tracking across all manufacturing stages
-- Idempotent: safe to run multiple times.
-- ============================================================

-- 1. Add variant_name column to stage_movements
ALTER TABLE stage_movements ADD COLUMN IF NOT EXISTS variant_name text;

-- 2. Add variant_name column to dispatches
ALTER TABLE dispatches ADD COLUMN IF NOT EXISTS variant_name text;

-- 3. Update record_split_movement_and_scrap RPC
...
-- 4. Update record_multi_variant_movements RPC
