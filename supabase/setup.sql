...
-- ============================================================
-- PART 26: Factory RBAC Triggers, Audit Columns & Station Provisioning
-- ============================================================
...
BEGIN
  ...
  IF v_user_id IS NOT NULL THEN
    ...
    -- If role found and not admin or stock_manager, enforce operator transition boundary
    IF v_user_role IS NOT NULL AND v_user_role NOT IN ('admin', 'stock_manager') THEN
...
-- Allow read-only access to anon for kiosk displays and views
...
-- 6. Provision standard factory workstations
...
-- ============================================================
-- PART 27: Critical Performance & Composite Indexes
-- ============================================================
...
-- ============================================================
-- PART 28: Multi-Batch Stage Movement & Scrap Atomic RPC
-- ============================================================
