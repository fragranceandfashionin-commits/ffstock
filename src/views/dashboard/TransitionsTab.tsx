                    ...
                    <td className="px-4 py-3 text-right">
                      {!isReversal && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold text-amber-700 hover:text-amber-800 bg-amber-50 hover:bg-amber-100 border border-amber-200 transition cursor-pointer"
